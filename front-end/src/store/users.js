  ...
  reducers: {
    update(state, action) {
      ...
      action.payload.forEach(element => {
        state.items.push({id:element._id,name:element.name,email:element.email,role:element.role,company:element.company,accountComfirmation:element.accountComfirmation})
      });
    },
